...
Authors: Dominik Hejda (256735), David Karas (256749), David Kaláb (256750)
...
Security
--------
This is a demo/local setup. The default publish authorization key is set in `backend/server_live.js`. Change it before exposing this service on a public network.

Further improvements
--------------------
- Add HTTPS certificates and secure headers in the Nginx configuration for production use.
- Add authentication for the web UI and harden the WebSocket connection.

Contact
-------
For questions about this project, contact the authors listed at the top of the file.
